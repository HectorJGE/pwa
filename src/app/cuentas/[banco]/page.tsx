...
export default function CuentasBanco() {
  ...
  const banco = params?.banco as string;
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen text-black p-2 md:p-10">
      <div className="bg-white p-4 md:p-10 rounded-lg shadow lg:w-1/2 w-full">
        <a href="/bancos" className="bg-gray-300 p-2 rounded-md">Volver</a>
        <h1 className="text-xl font-bold text-center mb-2">Cuentas </h1>
        {loading ? (
